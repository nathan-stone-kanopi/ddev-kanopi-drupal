...
This add-on provides 27 custom commands:
...
### Remove the Add-on
```bash
# Remove the add-on completely (includes Redis, Solr, and all 27 commands)
...
- ✅ Removes all 27 custom commands
...
- Validates all 27 custom commands are available and functional
